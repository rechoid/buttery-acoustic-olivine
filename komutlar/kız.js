...
.setDescription(`${user} Bayan Olarak Kaydedildi. \n\n İsmini Değiştirmek İçin \`${ayarlar.prefix}i @kişi isim\``)
message.channel.send(embed)
  user.addRole("752224828676636703").then(y => y.addRole("7522248305307a81327")).then(ys => ys.removeRole("754022574064926731"))
